...
// import 'package:pregnancy_app/views/layouts/calender/event_item.dart';
...
//         Obx(
//           () {
//             if (eventController.recommendEvents.isEmpty) {
//               return Center(
//                 child: Text(
//                   "No upcoming events.",
//                   style: TextStyle(
...
//                   itemCount: eventController.recommendEvents.length,
