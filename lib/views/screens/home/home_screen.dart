...
class HomeScreen extends StatelessWidget {
  ...
  final int currentWeek = 7;
  final int additionalDays = 3;
  final double donePercent = 18.9;
  final int daysToGo = 228;
  ...
  Widget _buildProgressInfo() {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ProcessInfoWidget(value: '$donePercent%', label: 'DONE'),
...
// Progress info widget (e.g. "18.9% DONE")

// Simple feature card with background color and icon
...
// Feature card with gradient, text, button, and right-side image
