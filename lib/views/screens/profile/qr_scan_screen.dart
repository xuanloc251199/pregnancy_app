...
class QrScanScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final String nextScreen = Get.arguments ?? '';
    print('arguments: $nextScreen');
    return Scaffold(
          ...
          MobileScanner(
            onDetect: (BarcodeCapture barcodeCapture) {
              ...
              if (barcode != null && barcode.rawValue != null) {
                qrScanController.processQrData(barcode.rawValue!);
                // Get.back(result: qrScanController.scannedData);

                Get.toNamed(nextScreen,
                    arguments: qrScanController.scannedData);
